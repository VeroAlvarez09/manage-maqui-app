        ...
        <div class="col-12 col-md-3">
          <q-card>
            ...
            <q-card-actions vertical>
              ...
              <br>
              <q-btn color="negative" @click="deleteUser" disable>Eliminar</q-btn>
              <br>
              <q-btn flat @click="back">Regresar</q-btn>
            </q-card-actions>
          </q-card>
...
<script>
  ...
  export default {
    ...
    methods: {
      edit() {
        this.$router.push('/zone/partner/new/' + this.id)
      },
      back() {
      ...
      onRequest() {
        ...
        ServiceApi.get("/zone/partners/get?id=" + this.documento).then(response => {
